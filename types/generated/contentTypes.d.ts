...
export interface ApiEvaluationStepEvaluationStep
  extends Struct.CollectionTypeSchema {
  collectionName: 'evaluation_steps';
  info: {
    description: '';
    displayName: 'Evaluation Step';
    pluralName: 'evaluation-steps';
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#FF0084'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiWorkshopSerieWorkshopSerie
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    evaluation_steps: Schema.Attribute.Relation<
      'oneToMany',
      'api::evaluation-step.evaluation-step'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
